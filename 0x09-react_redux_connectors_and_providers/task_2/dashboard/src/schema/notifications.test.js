...
describe("Test for notifications.js", () => {
  ...
  it("verifies that the normalized data has the correct result array.", () => {
    const result = [
  ...
  it("verifies that the normalized data has the correct users entity.", () => {
    const user = {
      age: 25,
  ...
  it("verifies that the normalized data has a correct messages entity.", () => {
    const message = {
  ...
  it("verifies that the normalized data has a correct notifications entity.", () => {
    const notification = {
